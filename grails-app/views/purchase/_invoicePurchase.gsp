        ...
        <tbody>
          ...
          <tr class="prop">
              <td valign="top" class="value ${hasErrors(bean: purchaseInstance, field: 'invoices', 'errors')}">
                  <g:select name="invoiceSelected" from="${com.vitaflo.innova.Invoice.findAllByPurchaseIsNull().sort{it.number}}" optionValue="viewPurchase" optionKey="id" value="${invoiceSelected}" />
              </td>
          </tr>
          <tr class="prop">
                <td valign="middle">
