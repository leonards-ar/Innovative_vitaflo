  ...
  <table style="margin-top: 5px;">
   ...
   <tbody>
      ...
      <td valign="top" class="value">
         <g:select name="addLot" value="${addCommand?.lot}" list="[]" noSelection="['':'']"/>
      </td>      
    ...
    <g:each in="${invoiceDetailList}" status="i" var="invoiceDetailList">
      ...
      <td valign="top" class="value">
         <g:select name="lot[${i}]" value="${invoiceDetail.productStock?.lot}" list="[]" noSelection="['':'']"/>
      </td>
